...
gold_file = working_dir / "logic_correct_answers.txt"
...
for pred_file in pred_files:
    ...
    output_file = working_dir / f"{prefix}_logic_score.txt"
    ...
    for i in range(total):
        try:
            ...
            if correct:
                ...
                wrong_problems.append(f"{i + 61}. Predicted: {pred_raw} | Correct: {gold_raw}")
        except Exception:
            wrong_problems.append(f"{i + 61}. ERROR parsing prediction or gold line")
