...
score_files = [f for f in os.listdir(directory) if f.endswith("_weight_score.txt")]

# Define model groups for side-by-side comparison
model_groups = {
    "Llama 3.2 3B": ["llama_3.2_3b_instruct", "llama_3.2_3b_instruct_z3"],
    "Gemma 3 4B": ["gemma_3_4b", "gemma_3_4b_z3"],
    "DeepSeek R1 8B": ["deepseek_r1_distill_llama_8b", "deepseek_r1_distill_llama_8b_z3"],
    "Llama 3.1 8B": ["meta_llama_3.1_8b", "meta_llama_3.1_8b_z3"],
    ...
    try:
        with open(path, "r", encoding="utf-8") as f:
            ...
            if "Score:" in first_line and "/" in first_line:
                ...
                label = file.replace("_weight_score.txt", "")
...
ax.set_title('Model Math Scores: Base vs Z3 Variants')
ax.set_xticks(x)
ax.set_xticklabels(group_names, rotation=45, ha='right')
ax.set_ylim(0, 22)  # Slightly higher to accommodate labels
ax.legend()
...
# Save and show
plot_file = os.path.join(directory, "weight_model_scores_grouped.png")
