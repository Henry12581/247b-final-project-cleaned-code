...
stdout_log = open("deepseek_v3_full_z3_cleaned_by_api.txt", "w", encoding="utf-8")
...
def clean_problem_with_deepseek_stream(problem_text):
    try:
        ...
        stream = client.chat.completions.create(
            model=MODEL_ID,
            messages=[
                {"role": "system", "content": "Clean,debug and retain one working python block only."},
